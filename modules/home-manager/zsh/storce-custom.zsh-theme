...
# Modify Git prompt
ZSH_THEME_GIT_PROMPT_PREFIX=" on $PR_GITHUB"
...
${PR_LINE}${PR_ULCORNER}${PR_HBAR}${PR_GREY} \
${PR_PATH}%${PR_PWDLEN}<...<%~%<<\
${PR_GREY} $(virtualenv_prompt_info)$(ruby_prompt_info)${PR_LINE}${PR_HBAR}${PR_HBAR}${(e)PR_FILLBAR}${PR_HBAR}\
${PR_LINE}${PR_HBAR}\

${PR_LINE}${PR_LLCORNER}${PR_HIGHLIGHT}${PR_HBAR}(\
%{$reset_color%}$(git_prompt_info)$(git_prompt_status)${PR_HIGHLIGHT})${PR_LINE}${PR_HBAR}\
${PR_HBAR}\
>${PR_NO_COLOUR} '
...
PS2='${PR_LINE}${PR_HBAR}\
${PR_HIGHLIGHT}${PR_HBAR}(\
${PR_LIGHT_GREEN}%_${PR_HIGHLIGHT})${PR_HBAR}\
${PR_LINE}${PR_HBAR}${PR_NO_COLOUR} '
